...
```{r, out.width = "100%", fig.alt = "This chapter will demonstrate how to: Understand the purpose of a Dockerfile Modify a Dockerfile to build a new imageManage image using tags Add a new package to a Docker image", echo = FALSE}
