...
```{r, out.width = "100%", fig.alt = "This chapter will demonstrate how to: Recognize the importance of keeping protected data safe as it relates to images Understand best practices for containerizationContrast the different online destinations for sharing a Docker image Change the name of a image Push an image to Dockerhub for sharing purposes", echo = FALSE}
