...
```{r prereqs, out.width = "100%", fig.alt = "Since this course builds on concepts introducted in previous reproducibility courses, visit these resources if needed prior to using this course.", echo = FALSE}
...
The specific topics covered in this course include the benefits of using containers, using images/containers created by others, modifing images/containers, and using volumes to link to your data to a container, and troubleshooting best practices when working with containers.
