...
```{r, out.width = "100%", fig.alt = "Containers for Scientists. For individuals who:Are comfortable with bash and command line. Perhaps tried to use Docker or other container managers before but felt overwhelmed or confused on how to get started. Want to learn best practices for using containers", echo = FALSE}
...
```{r, out.width = "100%", fig.alt = "Topics covered in Containers for Scientists: Why use containers/images? Using images Modifying images And containers Using volumes Troubleshooting Best practices for containers", echo = FALSE}
