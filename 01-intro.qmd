...
```{r prereqs, out.width = "100%", fig.alt = "Topics covered in Containers for Scientists: Why use containers/images? Using images Modifying images And containers Using volumes Troubleshooting Best practices for containers", echo = FALSE}
